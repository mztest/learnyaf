...
class Security extends Object
{
    ...
    public function hashData($data, $key, $rawHash = false)
    {
        ...
        if (!$hash) {
            throw new Exception('Failed to generate HMAC with hash algorithm: ' . self::MAC_HASH);
        }
        return $hash . $data;
    }
     ...
     * @throws Exception when an unsupported password hash strategy is configured.
